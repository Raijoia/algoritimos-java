...
public class Exercicio48 {
      ...
      switch (opcao) {
        ...
        case 'C':
          if (ra == null || notas == null) {
            ...
            realizarBuscaBunaria(ra, notas, scanner);
          }
          break;
        case 'D':
  ...
  public static void realizarBuscaBunaria(int[] ra, double[] notas, Scanner scanner) {
    ...
    while (inicio <= fim) {
      ...
      if (ra[meio] == raBusca) {
        System.out.println("Nota do aluno de RA " + ra[meio] + ": " + notas[meio]);
        encontrado = true;
        break;
