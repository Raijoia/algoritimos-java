...
public class Exercicio49 {
  public static void main(String[] args) {
    ...
    int indice = buscaBinariaIterativa(vetor, elemento, 0, vetor.length - 1);
  ...
  public static int buscaBinariaIterativa(char[] vetor, char elemento, int inicio, int fim) {
    ...
    if (vetor[meio] == elemento) {
      ...
      inicio = meio + 1;
      return buscaBinariaIterativa(vetor, elemento, inicio, fim);
    } else {
      fim = meio - 1;
      return buscaBinariaIterativa(vetor, elemento, inicio, fim);
    }
